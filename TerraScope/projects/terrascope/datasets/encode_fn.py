...
def video_lisa_encode_fn_new(
    ...
    region_token_id = tokenizer.convert_tokens_to_ids('<REGION>')
    
    if region_token_id is not None:
        labels = [
            IGNORE_INDEX if input_id == region_token_id else label
