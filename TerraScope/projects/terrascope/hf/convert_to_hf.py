...
def main():
    ...
    from projects.terrascope.hf.models.configuration_sa2va_chat import Sa2VAChatConfig
    from projects.terrascope.hf.models.modeling_sa2va_chat import Sa2VAChatModel
    ...
    # copy the files
    os.system(f"cp -pr ./projects/terrascope/hf/models/* {args.save_path}")
