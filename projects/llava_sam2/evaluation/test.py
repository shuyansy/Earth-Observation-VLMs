...
def parse_args():
    ...
    parser.add_argument('--model_path', default="/scqian/Earthmind_proj/multi_weight_final")
    parser.add_argument('--results_dir', default="pair_multimcq_rgb_ms", help='The dir to save results.')
    parser.add_argument('--select', type=int, default=-1)
    parser.add_argument("--annotation_files", nargs='+', default=["/scqian/ms_scene_classification_qa.json"],\
                        help="List of annotation JSON files.")
    parser.add_argument("--image_dir", default="/scqian/ms_sar", type=str,
